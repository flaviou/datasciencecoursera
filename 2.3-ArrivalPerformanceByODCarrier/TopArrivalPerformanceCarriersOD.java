...
public class TopArrivalPerformanceCarriersOD {
...
/*
            if ((liCancelled == 0) && (liDiverted ==0) && (
               ((lsOriginAirportID.equals("\"CMI\"")) && (lsDestinationAirportID.equals("\"ORD\""))) ||
               ((lsOriginAirportID.equals("\"IND\"")) && (lsDestinationAirportID.equals("\"CMH\""))) ||
               ((lsOriginAirportID.equals("\"DFW\"")) && (lsDestinationAirportID.equals("\"IAH\""))) ||
               ((lsOriginAirportID.equals("\"LAX\"")) && (lsDestinationAirportID.equals("\"SFO\""))) ||
               ((lsOriginAirportID.equals("\"JFK\"")) && (lsDestinationAirportID.equals("\"LAX\""))) ||
               ((lsOriginAirportID.equals("\"ATL\"")) && (lsDestinationAirportID.equals("\"PHX\""))))) {
*/
            if ((liCancelled == 0) && (liDiverted ==0)) {
              context.write(new Text(lsOriginAirportID + "-" + lsDestinationAirportID + "-" + lsCarrier), new IntWritable((int) liArrDelayMinutes));
            }
        }
    }
