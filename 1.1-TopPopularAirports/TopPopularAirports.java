...
public class TopWords {
    ...
    public static class WordCountMap extends Mapper<Object, Text, Text, IntWritable> {
        final int OriginalAirportID = 11;
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(tokens[OriginalAirportID]), new IntWritable(1));
            context.write(new Text(tokens[DestinationAirportID]), new IntWritable(1));
        }
    }
